...
public class ForgeRegistryBackedSyncedRegistry<T extends ISyncedRegistryEntry<T, G>, G extends ISyncedRegistryEntryType<T, G>> implements ISyncedRegistry<T, G> {
    ...
    private final Function<BiMap<ResourceLocation, T>, CustomPacketPayload> payloadBuilder;
    ...
    public ForgeRegistryBackedSyncedRegistry(
            ...
            final Function<BiMap<ResourceLocation, T>, CustomPacketPayload> payloadBuilder
    ) {
    ...
    public void synchronizeAll() {
        PacketDistributor.ALL
                .noArg()
                .send(this.payloadBuilder.apply(this.syncedEntriesMap));
    }
