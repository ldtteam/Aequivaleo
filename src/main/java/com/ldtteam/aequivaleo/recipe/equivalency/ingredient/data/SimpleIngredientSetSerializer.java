...
public class SimpleIngredientSetSerializer implements JsonSerializer<Set<IRecipeIngredient>>, JsonDeserializer<Set<IRecipeIngredient>>
{
    ...
    public Set<IRecipeIngredient> deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context) throws JsonParseException
    {
        ...
        StreamSupport.stream(entries.spliterator(), false)
                 .map(e -> context.deserialize(e, SimpleIngredientSerializer.HANDLED_TYPE))
