...
public abstract class ValueInformationProvider implements IDataProvider
{
    ...
    {
        final Path dataSavePath = dataGenerator.getOutputFolder().resolve(String.format("data/%s/aequivaleo/value/%s", modId, worldData.getPath()));
